    ...
    <div className="min-h-screen p-4 bg-gray-100">
      ...
      <div className="max-w-6xl mx-auto p-6 bg-white rounded shadow-md mt-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex flex-col">
            <label htmlFor="catagory" className="text-sm font-medium">Category:</label>
            <input
              type="text"
              id="catagory"
              value={catagory}
            ...
            <table className="min-w-full border border-gray-200">
              <thead className="bg-gray-100">
                <tr className="text-left">
                  ...
                  <th className="px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">Added At</th>
                  <th className="px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">Actions</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
