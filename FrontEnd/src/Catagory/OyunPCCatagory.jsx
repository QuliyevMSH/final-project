...
import OyunPCComment from './OyunPCComment';

const OyunPCCatagory = () => {
    ...
    useEffect(() => {
        const fetchNotes = async () => {
            try {
                ...
                const filteredNotes = res.data.allNotes.filter(note => note.catagory === 'Oyun PC');
