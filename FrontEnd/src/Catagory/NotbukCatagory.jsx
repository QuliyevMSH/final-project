...
import NotbukComment from './NotbukComment';

const NotbukCatagory = () => {
    ...
    useEffect(() => {
        const fetchNotes = async () => {
            try {
                ...
                const filteredNotes = res.data.allNotes.filter(note => note.catagory === 'Notbuk');
