    ...
    useEffect(() => {
        const fetchreviews = async () => {
            try {
                ...
                const filteredreviews = res.data.filter(review => review.catagory === 'Klaviatura');
        ...
        <div className="container px-4 mx-auto">
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-center text-gray-800 sm:text-4xl">
              Müştərilərin Klaviatura haqqında rəyləri
            </h2>
            <p className="text-center text-gray-600">
              Müştərilərin rəyləri burada görünür.
            </p>
          </div>
            ...
            {charms.map((review, index) => (
              ...
              >
                ...
                <p className="text-sm text-gray-500 mt-2">
                  Göndərilmə tarixi: {review.addedAt ? new Date(review.addedAt).toLocaleString() : 'Gizlədilib'}
                </p>
              </div>
            ))}
          </div>
...
export default KlaviaturaComment;
