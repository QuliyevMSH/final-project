    ...
    useEffect(() => {
        const fetchreviews = async () => {
            try {
                ...
                const filteredreviews = res.data.filter(review => review.catagory === 'Qulaqliq');
        ...
        <div className="container px-4 mx-auto">
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-center text-gray-800 sm:text-4xl">
              Müştərilərin Qulaqlıq haqqında rəyləri
            </h2>
...
export default QulaqliqComment;
