...
import YaddasKartiComment from './YaddasKartiComment';

const YaddasKartiCatagory = () => {
    ...
    useEffect(() => {
        const fetchNotes = async () => {
            try {
                ...
                const filteredNotes = res.data.allNotes.filter(note => note.catagory === 'YaddasKarti');
...
export default YaddasKartiCatagory;
