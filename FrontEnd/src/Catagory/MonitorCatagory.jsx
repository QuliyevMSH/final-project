...
import MonitorComment from './MonitorComment';

const MonitorCatagory = () => {
    ...
    useEffect(() => {
        const fetchNotes = async () => {
            try {
                ...
                const filteredNotes = res.data.allNotes.filter(note => note.catagory === 'Monitor');
...
export default MonitorCatagory;
