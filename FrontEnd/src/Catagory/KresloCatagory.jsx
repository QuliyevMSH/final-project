...
import KresloComment from './KresloComment';

const KresloCatagory = () => {
    ...
    useEffect(() => {
        const fetchNotes = async () => {
            try {
                ...
                const filteredNotes = res.data.allNotes.filter(note => note.catagory === 'Kreslo');
