...
import QulaqliqComment from './QulaqliqComment';

const QulaqliqCatagory = () => {
    ...
    useEffect(() => {
        const fetchNotes = async () => {
            try {
                ...
                const filteredNotes = res.data.allNotes.filter(note => note.catagory === 'Qulaqliq');
...
export default QulaqliqCatagory;
